...
engine = create_async_engine(DATABASE_URL, poolclass=pool.NullPool, echo=False)
...
class TripGroup(Base):
    ...
    dest_lat = Column(Float, nullable=True) # 🛠️ RE-ADDED
    dest_lon = Column(Float, nullable=True) # 🛠️ RE-ADDED
...
class GroupMember(Base):
    ...
    # 🛠️ STABILITY FIX: Prevent duplicate member errors
